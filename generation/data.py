...
class FLAGS(object):
    def __init__(self):
        ...
        self.d_lr = 0.00001 # "Learning rate of for adam [0.0002]")
        self.beta1 = 0.5 # "Momentum term of adam [0.5]")
        self.batch_size = 2 # "The number of batch images [64]")
        self.output_size = 256 # "The size of the output images to produce [64]")
        self.output_size2 = 256 # "The size of the output images to produce [64]")
...
def get_data(output_size, n_epoch, batch_size):
    ...
    ds = train_ds.shuffle(buffer_size=25)
